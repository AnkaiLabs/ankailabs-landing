      ...
      <SectionContainer className="flex flex-col gap-8 md:flex-row md:items-start md:justify-between">
        <div>
          ...
          <div className="mt-4 flex items-center gap-3">
            <a
              href="https://www.instagram.com/ankailabs/"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Instagram de ANKAI LABS"
              className="text-text-tertiary transition-colors hover:text-white"
            >
              <InstagramIcon />
            </a>
            <a
              href="https://www.facebook.com/ankailabs/"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Facebook de ANKAI LABS"
              className="text-text-tertiary transition-colors hover:text-white"
            >
              <FacebookIcon />
            </a>
        ...
        <div className="text-sm text-text-tertiary">
          <p>hola@ankailabs.cl</p>
          <p className="mt-1">© 2026 ANKAI LABS SpA.</p>
        </div>
      </SectionContainer>
    </footer>
  );
